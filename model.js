...
const camera = new THREE.PerspectiveCamera(45, div.clientWidth / div.clientHeight, 0.1, 50);
...
const plane = new THREE.Mesh(
	...
	new THREE.MeshPhysicalMaterial({color: 0xC2C2C2,
...
const box = new THREE.Mesh(
	...
	new THREE.MeshPhysicalMaterial({color: 0xB594C8,
	side: THREE.DoubleSide}) 
);
...
const material1 = new THREE.MeshPhongMaterial( { color: 0x81695D, side:THREE.DoubleSide	} );
...
const material2 = new THREE.MeshPhongMaterial( { color: 0xB594C8, side:THREE.DoubleSide } );
